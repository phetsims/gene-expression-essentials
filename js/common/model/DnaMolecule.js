...
define( require => {
  ...
  const BasePair = require( 'GENE_EXPRESSION_ESSENTIALS/common/model/BasePair' );
  const DnaStrandPoint = require( 'GENE_EXPRESSION_ESSENTIALS/common/model/DnaStrandPoint' );
