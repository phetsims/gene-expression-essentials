...
(5) Open in the browser: `http://localhost/gene-expression-essentials/gene-expression-essentials_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
...
(3) Open in the browser: `http://localhost/gene-expression-essentials/build/adapted-from-phet/gene-expression-essentials_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
